 ...
 */
  public ElevatorIO(Elevators elevators) {
    ...
    if (Elevators.rmi) {
      try {
          System.err.println(" create an RMI interface");
       ...
       // System.setProperty("java.rmi.server.codebase", "file:///C:/Users/Yuuki/workspace/elevator/bin/");
  ...
  public void readInput() {
    ...
    try {
      while ((input = in.readLine()) != null) {
          System.out.println("recieved message from controller " + input);
        ...
        if (tokens[0].equalsIgnoreCase("i") || tokens[0].equalsIgnoreCase("info")) {
            System.out.println("sending info");
            out.println("i " + Elevators.numberOfElevators + " " + Elevators.numberOfFloors);
            continue;
        }
        System.err.println("Illegal command: " + input);
      }
